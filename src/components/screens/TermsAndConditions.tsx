        ...
        <div className="min-h-screen bg-gray-50 dark:bg-gray-950 flex flex-col">
            ...
            <main className="flex-1 max-w-3xl mx-auto w-full px-4 py-10">
                <div className="mb-8">
                    ...
                    <p className="text-body text-gray-500">{t('termsAndConditions.subtitle')}</p>
                </div>
                ...
                <div className="space-y-6">
                    {isLoading ? (
                        ...
                        <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-700 p-8 shadow-sm prose dark:prose-invert max-w-none">
                            <InlineEditableRich slug="terms" field="content" lang={language} value={cmsContent} />
                        </div>
                    ) : (
            ...
            <footer className="border-t bg-white dark:bg-gray-900 py-5 px-4">
                <div className="max-w-3xl mx-auto flex flex-wrap justify-center gap-4 text-micro text-gray-400">
                    ...
                    <button onClick={() => onNavigate('termsAndConditions')} className="hover:text-[#f08a3c] transition-colors font-medium text-[#2a8fbd]">{t('legal.footer.terms')}</button>
