...
class QuickAccessAuth extends ResourceController
{
    ...
    public function verifyOtp()
    {
        ...
        try {
            ...
            $this->sendAdminNotification($companyName, $email, $subdomain, $tenantId);
            $telegram = new \App\Services\TelegramService();
            $telegram->tenantRegistered($companyName, $email, $subdomain, $tenantId);
...
HTML);
            ...
            log_message('error', '[QuickAccess] sendAdminNotification: ' . $e->getMessage());
        }
    }
